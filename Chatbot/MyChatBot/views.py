...
words = []
data = []
with open("C:/Python/Chatbot/MyChatBot/data.pickle", "rb") as f:
        words, labels, training, output = pickle.load(f)

with open("C:/Python/Chatbot/MyChatBot/dataset/question.json") as file:
    data = json.load(file)

model = tflearn.DNN(net)

model.load("C:/Python/Chatbot/MyChatBot/model/model.tflearn")
